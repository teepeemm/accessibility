...
\item Also:
\begin{itemize}
\setkeys{Gin}{height=3ex}
%\item \verb|\onslide<2>{\includegraphics{onslide}}|: \onslide<2>{\includegraphics{onslide}}
\item \verb|\alt<2>{\includegraphics{alt}}{Alt Hotel, Calgary East Village}|:\\
\alt<2>{\includegraphics{alt}}{Alt Hotel, Calgary East Village}
\item \verb|\temporal<2>{\includegraphics{before}}{\includegraphics{temporal}}|\\\hphantom{\ttfamily XtemporalX2X}\verb|{\includegraphics{after}}|:
\temporal<2>{\includegraphics{before}}{\includegraphics{temporal}}{\includegraphics{after}}
\end{itemize}
...
\end{lstlisting}
 ...
 \only<3>{\lstinputlisting[firstline=5,lastline=22]{exampleMatrix}}
 \only<4>{\lstinputlisting[firstline=8,lastline=25]{exampleMatrix}}
 \only<5>{\lstinputlisting[firstline=11,lastline=28]{exampleMatrix}}
 \only<6>{\lstinputlisting[firstline=13]{exampleMatrix}}
 \begin{onlyenv}<6>
 \begin{lstlisting}
\end{frame}
\end{lstlisting}
...
\item Fails in previous example: everything alerted\\
\verb#<projector:(spec)|handout:(spec)># for the handout to have everything\\
\verb#<projector:(spec)|article># for the handout to have last slide
%\newcommand{\colvect}[1]{%

...
%\savebox\logobox{\includegraphics[artifact, height=2ex]{flame-w-rgb}}
...
%   \put(\paperwidth - \wd\logobox - 0.5cm,
%        -\ht\logobox -0.5cm){\usebox\logobox}}
...
\item[wallpaper] header and footer have background color but no text
\end{description}
\end{minipage}%
\begin{minipage}{.5\textwidth}
\maketitle[

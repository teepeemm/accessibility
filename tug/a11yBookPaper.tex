...
\begin{itemize}
\ttfamily
\item\cs{includegraphics}[\textbf{alt=\{...\}}]
\item\cs{tikz}[\textbf{alt=\{...\}}]
\item\cs{begin}\{tikzpicture\}[\textbf{alt=\{...\}}]
\item\cs{begin}\{picture\}[\textbf{alt=\{...\}}]
\end{itemize}
We also have two other options to \texttt{alt=\{...\}}:
...
Less commonly, we can use \texttt{actualtext=\{...\}}
so that screen readers act as if there is no image, and instead read the text.
...
rmarkdown: \verb|\setkeys{Gin}{alt={...}}|

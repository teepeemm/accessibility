...
I had originally formatted headings using the \texttt{titlesec} package.
This requires adjustments to properly tag,
and was becoming too complicated.
...
I was originally using \texttt{enumitem} to adjust \tubbraced{enumerate}
...
I needed to adjust \texttt{media9} to properly tag
the three dimensional images.
This involved a deep dive into tagging internals that I wouldn't recommend for
beginners.
...
Another approach is to verify that the \PDF\ is indeed version 2.0,
...
%As a final remark, don't be afraid to dig into 

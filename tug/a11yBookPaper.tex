...
It is useful to note that it is not too difficult to create alt text.
A majority of our discussion requires some familiarity with creating
a longer \LaTeX\ document.
For alt text, however, we used a short Python script that added
...
the book, examine the resulting \PDF, and supply the alt text.
...
PDF/UA-2 & 1723 & 12926774 \\
WTPDF 1.0 Accessibility & 1719 & 12926770 \\
WTPDF 1.0 Reuse & 1706 & 11679799 \\\bottomrule
\end{tabular}
\end{table}

...
Often, a linked issue would contain code snippets I could copy and paste
...
I often turned to \url{https://tex.stackexchange.com/} for help.
(In more extreme cases, I reported a bug at
...
\end{itemize}
There are also two other options to \texttt{alt=\tubbraced{...}}:
...
omit the more informative \MathML\ tags, so I discourage its use
...
While \cs{multicolumn} is tagging ready, I cannot say the same for
...
I had originally formatted our headings using the \texttt{titlesec} package.
This requires adjustments to properly tag,
and was becoming too complicated for our use.
I opted to instead use \cs{@startsec}
...
I needed to verify that our result was indeed accessible.
...
The main downside I found with \veraPDF\ is that
...
requiring me to modify the compilation command

...
Where \texttt{beamer} has the concept of a \emph{fragile} frame
that uses verbatim or listings to change the catcodes,
\ltxtalk\ does this when a \tubbraced{frame*} environment is used.
